...
public class MainActivity extends AppCompatActivity {
    ...
    void init() {
        SetSize(Qz[0],1,1,"兵");SetPois(Qz[0],4,0);
        SetSize(Qz[1],1,1,"兵");SetPois(Qz[1], 3, 1);
        SetSize(Qz[2], 1, 1, "兵");
        SetPois(Qz[2], 3, 2);
        SetSize(Qz[3], 1, 1, "兵");
        SetPois(Qz[3], 4, 3);

        SetSize(Qz[4], 1, 2, "张飞");SetPois(Qz[4], 0, 0);
        SetSize(Qz[5],1,2,"赵云");SetPois(Qz[5],0,3);
        SetSize(Qz[6],1,2,"马超");SetPois(Qz[6],2,0);
        SetSize(Qz[7],1,2,"黄忠");SetPois(Qz[7],2,3);

        SetSize(Qz[8],2,1,"关羽");SetPois(Qz[8],2,1);
        SetSize(Qz[9],2,2,"曹操");SetPois(Qz[9], 0, 1);
